...
export function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        type="text"
        className="p-4 rounded-lg bg-zinc-800 text-white placeholder:text-zinc-400 mt-3 focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-zinc-900"
        id="title"
        value={title}
